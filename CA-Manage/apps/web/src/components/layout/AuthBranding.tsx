  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        >
          <span className="font-black text-base" style={{ color: '#111827' }}>CA</span>
        </div>
        <span className="font-semibold text-lg" style={{ color: '#FFFFFF' }}>CA Manage</span>
      </div>
        ...
        <div className="space-y-3">
          {features.map((feature, i) => (
            ...
            >
              ...
              <span className="text-sm" style={{ color: '#D1D5DB' }}>{feature}</span>
            </motion.div>
          ))}
        </div>
      </motion.div>
      ...
      <p className="text-sm" style={{ color: '#4B5563' }}>
        © 2025 CA Manage. All rights reserved.
      </p>
    </div>
  );
}
