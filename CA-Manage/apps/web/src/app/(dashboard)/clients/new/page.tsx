...
function SectionTitle({ title }: { title: string }) {
  return <h3 className="text-xs font-semibold uppercase tracking-wide pt-2" style={{ color: '#6B7280' }}>{title}</h3>;
}
    ...
    <div className="max-w-2xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <h1 className="text-lg font-bold" style={{ color: '#111827' }}>Add Client</h1>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-2xl border p-6 space-y-5" style={{ borderColor: '#E5E7EB' }}>
        ...
        <div className="flex gap-3 pt-2">
          <Button type="button" variant="secondary" onClick={() => router.push('/clients')}>Cancel</Button>
