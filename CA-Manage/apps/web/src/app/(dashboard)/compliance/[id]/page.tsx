    ...
    <div className="max-w-4xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-lg font-bold" style={{ color: '#111827' }}>{record.title}</h1>
        </div>
      ...
      <div className="grid grid-cols-3 gap-5">
        <div className="col-span-2 bg-white rounded-2xl border p-5" style={{ borderColor: '#E5E7EB' }}>
          <h3 className="text-sm font-semibold mb-3" style={{ color: '#111827' }}>Description</h3>
          ...
          <div className="bg-white rounded-2xl border p-4 space-y-4" style={{ borderColor: '#E5E7EB' }}>
            ...
            {record.client && (
              <div className="pt-3" style={{ borderTop: '1px solid #F3F4F6' }}>
                ...
                <a href={`/clients/${record.client.id}`} className="text-sm font-medium hover:underline" style={{ color: '#111827' }}>
