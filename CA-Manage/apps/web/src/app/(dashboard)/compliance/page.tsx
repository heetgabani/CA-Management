  ...
  const columns: Column<any>[] = [
    ...
    },
    {
      ...
      render: (row) => row.client
        ? <span className="text-sm" style={{ color: '#374151' }}>{row.client.displayName}</span>
      ...
      render: (row) => {
        ...
        return (
          <div className="flex items-center gap-1.5">
            {(isOverdue || isDueSoon) && <AlertTriangle size={12} style={{ color: isOverdue ? '#DC2626' : '#D97706' }} />}
            <span className="text-sm" style={{ color: isOverdue ? '#DC2626' : isDueSoon ? '#D97706' : '#374151' }}>
    ...
    },
    {
      ...
      render: (row) => row.assignedTo
        ? <span className="text-sm" style={{ color: '#374151' }}>{row.assignedTo.firstName} {row.assignedTo.lastName}</span>
          ...
          {TYPE_TABS.map(t => (
            <button
              ...
              style={{
                ...
                color: type === t.key ? '#111827' : '#6B7280',
