...
export default function StaffDetailPage() {
  ...
  if (!member) return (
    <div className="text-center py-16">
      <p style={{ color: '#6B7280' }}>Staff member not found</p>
    ...
    <div className="max-w-3xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <h1 className="text-lg font-bold" style={{ color: '#111827' }}>{fullName}</h1>
        </div>
      </div>

      {/* Profile card */}
      <div className="bg-white rounded-2xl border p-6 mb-5" style={{ borderColor: '#E5E7EB' }}>
        <div className="flex items-start gap-5">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              <h2 className="text-base font-bold" style={{ color: '#111827' }}>{fullName}</h2>
      ...
      <div className="grid grid-cols-3 gap-4 mb-5">
        {[
          ...
          <div key={stat.label} className="bg-white rounded-2xl border p-4 text-center" style={{ borderColor: '#E5E7EB' }}>
      ...
      <div className="bg-white rounded-2xl border p-5" style={{ borderColor: '#E5E7EB' }}>
        <h3 className="text-sm font-semibold mb-4" style={{ color: '#111827' }}>Assigned Tasks</h3>
        {tasks.length === 0
