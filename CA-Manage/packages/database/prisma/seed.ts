...
async function main() {
  ...
  const superTenant = await prisma.tenant.upsert({
    ...
    update: {},
    create: { slug: 'super-admin', name: 'CA Manage Admin', plan: 'enterprise', maxUsers: 9999, maxStorage: BigInt(1_099_511_627_776) },
  });
  ...
  const notifTemplates = [
    ...
    { type: NotificationType.SYSTEM, title: 'System Update', body: (_: string) => 'CA Manage has been updated with new features.' },
  ];
