...
const TYPE_ICON: Record<string, any> = {
  ...
  DOCUMENT_UPLOADED:{ icon: FileText,    bg: '#ECFDF5', color: '#15803D' },
  STAFF_INVITED:    { icon: UserPlus,    bg: '#F3E8FF', color: '#7E22CE' },
  SYSTEM_ALERT:     { icon: Bell,        bg: '#FEF2F2', color: '#DC2626' },
};
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium" style={{ color: '#1F2937' }}>{n.title}</p>
                  {n.body && <p className="text-sm mt-0.5" style={{ color: '#64748B' }}>{n.body}</p>}
