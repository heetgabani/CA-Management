    ...
    <div className="max-w-2xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <h1 className="text-lg font-bold" style={{ color: '#1F2937' }}>Create Task</h1>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-2xl border p-6 space-y-5" style={{ borderColor: '#E2E8F0' }}>
        ...
        <div className="flex gap-3 pt-2">
          <Button type="button" variant="secondary" onClick={() => router.push('/dashboard/tasks')}>Cancel</Button>
