          ...
          >
            <div className="flex items-center gap-3 px-4 py-3 border-b border-[#E2E8F0]">
              ...
              <input
                ...
                className="flex-1 text-sm text-[#1F2937] placeholder:text-[#9CA3AF] focus:outline-none bg-transparent"
              />
                ...
                <div>
                  ...
                  {data.clients.map((c: any) => (
                    <button key={c.id} onClick={() => navigate(`/clients/${c.id}`)}
                      ...
                      <div className="w-7 h-7 rounded-full bg-[#F1F5F9] flex items-center justify-center text-xs font-semibold">
                        {c.displayName?.[0]}
                      </div>
                      <div>
                        <p className="text-sm font-medium text-[#1F2937]">{c.displayName}</p>
                ...
                <div>
                  ...
                  {data.documents.map((d: any) => (
                    <button key={d.id} onClick={() => navigate(`/clients/${d.clientId}/documents`)}
                      ...
                      <div>
                        <p className="text-sm font-medium text-[#1F2937]">{d.name}</p>
